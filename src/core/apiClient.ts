...
/**
 * Token del proveedor activo, sin disparar una peticion.
 *
 * Lo usa el chequeo de sesion del conductor (HU-62) para saber si hay algo
 * guardado antes de mostrar el panel. Es una lectura de presencia, no de
 * validez: eso lo decide el backend respondiendo 401/403.
 */
export function obtenerTokenActual(): string | null {
  return proveedorDeToken.obtenerToken();
}
