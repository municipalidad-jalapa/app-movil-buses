...
} from '../../../src/core/panelConductor';
import type { ParadaEta, ReservasActivasPorParada, Ruta, RutaEta } from '../../../src/core/tipos';
...
describe('Desarrollo-75 HU-75 - armarFilasPanelConductor', () => {
  it('AC2: acota el panel a las paradas de la ruta del conductor: nunca inventa filas', () => {
  ...
  it('AC1: trae las reservas activas de cada parada desde porParada', () => {
    const ruta = unaRuta();
  ...
  describe('AC6: confianza del ETA (DESIGN.md §9)', () => {
  ...
  describe('AC5: paradas atendidas', () => {
...
describe('Desarrollo-75 HU-75 - esDatoFresco (AC6, DESIGN.md §7)', () => {
